...
const MONGODB_URI =
  process.env.MONGODB_URI || "mongodb://127.0.0.1:27017/hattah";
...
const seedProductsIfEmpty = async () => {
  ...
  await Product.insertMany([
    ...
    },
    {
      ...
      price: 1499,
      description:
        "Lightweight botanical serum made for daily hydration and glow.",
      imageUrl:
    ...
    },
    {
      ...
      price: 1799,
      description:
        "Breathable cotton shirt featuring hand block print patterns.",
      imageUrl:
